 ...
 */
public class FrmSelecionarAutor extends javax.swing.JFrame implements ListagemModel {
    ...
    public FrmSelecionarAutor(FrmCadastroLivroTeste cadlivro) {
        initComponents();
        ...
        listAutor = (ArrayList<Autor>) aDao.buscarTodos("where status_autor != 0 order by nome");
        aDao.closeConnection();
        atualizarTabela();
    }
    
    public FrmSelecionarAutor(FrmVerLivro verLivro) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    public FrmSelecionarAutor(FrmEditarLivro editarLivro) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    public boolean isSelected() {
        int count = tabela_autor.getSelectedRowCount();

        if (count > 0) {
            if (count == 1) {
                return true;
            } else {
                JOptionPane.showMessageDialog(null, "Selecione apenas um autor");
                return false;
            }
        } else {
    ...
    public void setList(ArrayList<?> list) {
        this.listAutor = (ArrayList<Autor>) list;
        atualizarTabela();
    }
    ...
    private void initComponents() {
        ...
        tabela_autor.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        jScrollPane1.setViewportView(tabela_autor);
    ...
    private void txt_buscaTextValueChanged(java.awt.event.TextEvent evt) {//GEN-FIRST:event_txt_buscaTextValueChanged
        ...
        AutorDao aDao = new AutorDao();
        listAutor = (ArrayList<Autor>) aDao.buscarTodos(clause);
        aDao.closeConnection();
        atualizarTabela();
    ...
    private void btn_selecionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_selecionarMouseClicked
        if (isSelected()) {
            if(cadlivro != null) {
                cadlivro.setAutor(listAutor.get(tabela_autor.getSelectedRow()));
            } else if(verLivro != null) {
                verLivro.setAutor(listAutor.get(tabela_autor.getSelectedRow()));
            } else if(editarLivro != null) {
                editarLivro.setAutor(listAutor.get(tabela_autor.getSelectedRow()));
            }
            dispose();
        }
    ...
    private void btn_adicionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_adicionarMouseClicked
        if (!txt_busca.getText().equals("")) {
            int result = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja cadastrar o autor " + txt_busca.getText() + "?");
            if (result == 0) {
                AutorDao aDao = new AutorDao(new Autor(txt_busca.getText()));
                if (aDao.inserir()) {
                    JOptionPane.showMessageDialog(null, "Novo autor cadastrado com sucesso.");
                }
                listAutor = (ArrayList<Autor>)aDao.buscarTodos("where status_autor != 0 order by nome");
                aDao.closeConnection();
                atualizarTabela();
            ...
            JOptionPane.showMessageDialog(null, "Digite no campo de buscas o nome do autor que deseja cadastrar.");
        }
    ...
    private void btn_excluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_excluirMouseClicked
        if(isSelected()) {
            Autor autor = listAutor.get(tabela_autor.getSelectedRow());
            int result = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir o autor " + autor.getNome());
            
            if(result == 0) {
                autor.setStatusAutor(0);
                AutorDao aDao = new AutorDao(autor);
                aDao.excluir();
                listAutor = (ArrayList<Autor>)aDao.buscarTodos("where status_autor != 0 order by nome");
                aDao.closeConnection();
                atualizarTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSelecionarAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSelecionarAutor().setVisible(true);
            }
        });
    }
