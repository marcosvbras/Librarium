 ...
 */
public class FrmSelecionarArea extends javax.swing.JFrame implements ListagemModel {
    ...
    public FrmSelecionarArea() {
        initComponents();
    }
    
    // Construtor chamado pela tela "Cadastro de Livros"
    public FrmSelecionarArea(FrmCadastroLivroTeste cadlivro) {
        initComponents();
        setLocationRelativeTo(null);
        this.cadlivro = cadlivro;
        modelo = new DefaultTableModel();
        tabela_area.setModel(modelo);

        modelo.addColumn("Área");

        AreaDao aDao = new AreaDao();
        listArea = (ArrayList<Area>) aDao.buscarTodos("where status_area != 0 order by nome");
        aDao.closeConnection();
        atualizarTabela();
    }
    
    public FrmSelecionarArea(FrmVerLivro verLivro) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    public FrmSelecionarArea(FrmEditarLivro editarLivro) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    public void atualizarTabela() {
        ...
        if (listArea != null) {
            for (Area a : listArea) {
                modelo.addRow(new String[]{a.getNome()});
            }
        }
    }
    ...
    public boolean isSelected() {
        int count = tabela_area.getSelectedRowCount();

        if (count > 0) {
            if (count == 1) {
                return true;
            } else {
                JOptionPane.showMessageDialog(null, "Selecione apenas uma área");
                return false;
            }
        } else {
    ...
    public void setList(ArrayList<?> list) {
        this.listArea = (ArrayList<Area>) list;
        atualizarTabela();
    }
    ...
    private void initComponents() {
        ...
        tabela_area = new javax.swing.JTable();
        ...
        tabela_area.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        tabela_area.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tabela_area);
    ...
    private void txt_buscaTextValueChanged(java.awt.event.TextEvent evt) {//GEN-FIRST:event_txt_buscaTextValueChanged
        ...
        AreaDao aDao = new AreaDao();
        listArea = (ArrayList<Area>) aDao.buscarTodos(clause);
        aDao.closeConnection();
        atualizarTabela();
    ...
    private void btn_selecionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_selecionarMouseClicked
        if (isSelected()) {
            if(cadlivro != null) {
                cadlivro.setArea(listArea.get(tabela_area.getSelectedRow()));
            } else if(editarLivro != null) {
                editarLivro.setArea(listArea.get(tabela_area.getSelectedRow()));
            } else if(verLivro != null) {
                verLivro.setArea(listArea.get(tabela_area.getSelectedRow()));
            }
            dispose();
        }
    ...
    private void btn_adicionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_adicionarMouseClicked
        if (!txt_busca.getText().equals("")) {
            int result = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja cadastrar o área " + txt_busca.getText() + "?");
            if (result == 0) {
                AreaDao aDao = new AreaDao(new Area(txt_busca.getText()));
                if (aDao.inserir()) {
                    JOptionPane.showMessageDialog(null, "Nova área cadastrado com sucesso.");
                }
                listArea = (ArrayList<Area>)aDao.buscarTodos("where status_area != 0 order by nome");
                aDao.closeConnection();
                atualizarTabela();
            ...
            JOptionPane.showMessageDialog(null, "Digite no campo de buscas o nome da área que deseja cadastrar.");
        }
    ...
    private void btn_excluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_excluirMouseClicked
        if(isSelected()) {
            Area area = listArea.get(tabela_area.getSelectedRow());
            int result = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir a área " + area.getNome());
            
            if(result == 0) {
                area.setStatusArea(0);
                AreaDao aDao = new AreaDao(area);
                aDao.excluir();
                listArea = (ArrayList<Area>)aDao.buscarTodos("where status_area != 0 order by nome");
                aDao.closeConnection();
                atualizarTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSelecionarArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSelecionarArea().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabela_area;
